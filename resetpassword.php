...
<html lang="en" data-bs-theme="auto">
  <head><script src="../assets/js/color-modes.js"></script>
    ...
    <title>Redefinir senha · Jurídico</title>
...
<img class="mb-7 py-10 px-7" src="logo-oab.svg" alt="" width="200" height="200">
  <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
    
    <h1 class="h3 mb-3 fw-normal">Redefinir sua senha</h1>
