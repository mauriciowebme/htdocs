...
if(isset($_GET['delete'])){
    ...
    header("Location: ../admin/regnome.php");
  ...
  Registrar Mudança
      ...
      //Receber dados do formulário
        ...
        if(!empty($dados['AddAten'])){
          ...
          if(!$empty_input){
            $query = "INSERT INTO nomes (idu, old, new, resp, date) VALUES (:idu, :old, :new, :resp, NOW())";
            $edit = $pdo->prepare($query);
            $edit->bindParam(':idu', $dados['idu'], PDO::PARAM_INT);
            $edit->bindParam(':old', $dados['old'], PDO::PARAM_STR);
            $edit->bindParam(':new', $dados['new'], PDO::PARAM_STR);
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="col-md-5">
    ...
    <input type="text" name="idu" class="form-control" placeholder="0001" value="<?php echo $idu; ?>">
  </div>
  <div class="col-md-5">
    <label for="old" class="form-label">Nome Atual</label>
    <input type="text" name="old" class="form-control" placeholder="Erick Collins" value="<?php echo $old; ?>">
    
  </div>
  <div class="col-md-5">
    <label for="new" class="form-label">Nome Novo</label>
    <input type="text" name="new" class="form-control" placeholder="Erick Voltaire" value="<?php echo $new; ?>">
   
  </div>
  <div class="col-md-5">
    <label for="resp" class="form-label">Advogado</label>
    <input type="text" name="resp" class="form-control" placeholder="<?php echo $_SESSION['username']; ?>" value="<?php echo $_SESSION['username']; ?>" disabled>
  ...
  <input type="submit" class="btn btn-primary" value="Adicionar" name="AddAten">
    ...
    <hr>
      <h2>Registro de mudanças de nome</h2>
        ...
        <table class="table table-striped table-sm">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php echo $dados["idu"]; ?></td>
              <td><?php echo $dados["old"]; ?></td>
              <td><?php echo $dados["new"]; ?></td>
              <td><?php echo $dados["resp"]; ?></td>
              <td><?php echo $dados["date"]; ?></td>
              <td>
